...
module XBar
  module Examples
    ...
    # requires the 'xbar/client' file.  This enables us to exercise
    # all the XBar management server APIs.  This is accomplished by
    # starting an XBar configuration server in a separate process.
    #
    module Client
